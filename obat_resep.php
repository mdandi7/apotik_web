...
<head>
  ...
  <script type="text/javascript">
    function popup(e) {
      var alertpass =  e;
      alert(alertpass); // this is the message in ""
    }
...
<div class="col text-center pb-3">
  <h2 class="">Form Penjualan Dengan Resep</h2>
</div>
<form class="border border-primary rounded" method="post">
    ...
    <div class="form-group col">
    <label for="namadokter" class="font-weight-bold col-sm-3 col-form-label">Nama Dokter</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" id="namadokter" name="namadokter" name="namapasien" placeholder="Nama Dokter" required="required">
    </div>
  </div>
  <div class="form-group col">
  ...
  <div class="form-group col">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" id="hargaobat" name="hargaobat" placeholder="Harga" readonly="readonly">
    </div>
  </div>
  <div class="form-group col">
    <label for="jumlah" class="font-weight-bold col-sm-3 col-form-label">Jumlah</label>
    <div class="col-sm-5">
      <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah" required="required" oninput="fillTotHarga(this.value);">
    </div>
  </div>
  <div class="form-group col">
  ...
  <div class="form-group col">
    <label for="stokakhir" class="font-weight-bold col-sm-3 col-form-label">Jumlah Bayar</label>
    <div class="col-sm-5">
      <input type="number" class="form-control" id="bayar" placeholder="Jumlah Bayar" oninput="fillKembali(this.value);" required="required">
    </div>
  </div>
  <div class="form-group col">
    <label for="sisa" class="font-weight-bold col-sm-3 col-form-label">Sisa</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" id="sisa" name="sisa" placeholder="Sisa" readonly="readonly">
    </div>
  </div>
  <div class="form-group col">
    <div class="col-sm-5">
      <input class="btn btn-lg btn-primary btn-block" type="submit" name="submitresep"></input>
    </div>
  </div>
</form>
</div>
