  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on("click", ".btn-submit-penjualan", function(){
          ...
          var nama_pasien = $(".nama-pasien").val();
          var nama_dokter = $(".nama-dokter").val();
...
<form class="border border-primary rounded form-insert-pembelian" method="post">
    ...
    <div class="form-group col">
      ...
      <div class="col-sm-5">
        <input type="text" class="form-control nama-pasien" placeholder="Nama Pasien" required="required">
      </div>
    </div>
      <div class="form-group col">
      <label for="namadokter" class="font-weight-bold col-sm-3 col-form-label">Nama Dokter</label>
      <div class="col-sm-5">
        <input type="text" class="form-control nama-dokter" name="namapasien" placeholder="Nama Dokter" required="required">
      </div>
    </div>
